export const languageOptions = [
  ...
  { value: "javastacktrace", label: "Java Stacktrace" },
  ...
  { value: "jsstacktrace", label: "JS Stacktrace" },
  { value: "jsx", label: "JSX" },
